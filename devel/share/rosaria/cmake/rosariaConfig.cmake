...
if("TRUE" STREQUAL "TRUE")
  set(rosaria_SOURCE_PREFIX /home/bart/workspace/AERO/src/rosaria)
  set(rosaria_DEVEL_PREFIX /home/bart/workspace/AERO/devel)
  set(rosaria_INSTALL_PREFIX "")
  set(rosaria_PREFIX ${rosaria_DEVEL_PREFIX})
else()
  set(rosaria_SOURCE_PREFIX "")
  set(rosaria_DEVEL_PREFIX "")
  set(rosaria_INSTALL_PREFIX /home/bart/workspace/AERO/install)
...
if(NOT "/home/bart/workspace/AERO/devel/include " STREQUAL " ")
  set(rosaria_INCLUDE_DIRS "")
  set(_include_dirs "/home/bart/workspace/AERO/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosaria' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bart/workspace/AERO/src/rosaria/${idir}'.  Ask the maintainer 'Srećko Jurić-Kavelj <srecko.juric-kavelj@fer.hr>, Ivan Marković <ivan.markovic@fer.hr>, Reed Hedges <reed.hedges@aedpt.com>' to fix it.")
    endif()
