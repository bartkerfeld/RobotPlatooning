...
if(NOT "/home/bart/workspace/AERO/src/slave_navigator/include " STREQUAL " ")
  set(slave_navigator_INCLUDE_DIRS "")
  set(_include_dirs "/home/bart/workspace/AERO/src/slave_navigator/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'slave_navigator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bart/workspace/AERO/src/slave_navigator/${idir}'.  Ask the maintainer 'mrdlab <mrdlab@todo.todo>' to fix it.")
    endif()
